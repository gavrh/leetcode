...
exports.default = addTwoNumbersTests;
class ListNode {
...
function addTwoNumbers(l1, l2) {
    ...
    if ((l1 === null || l1 === void 0 ? void 0 : l1.next) === null && (l2 === null || l2 === void 0 ? void 0 : l2.next) === null)
        return list;
    list.next = next;
    l1 = l1 ? l1.next : null;
    l2 = l2 ? l2.next : null;
    while (l1 || l2) {
        console.log(l1, l2);
        console.log(l1 === null || l1 === void 0 ? void 0 : l1.val, l2 === null || l2 === void 0 ? void 0 : l2.val);
